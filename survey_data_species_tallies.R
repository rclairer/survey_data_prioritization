...
formatted_length <- flextable::set_header_labels(formatted_length,
...
formatted_age_structure <- flextable::set_header_labels(formatted_age_structure,
                                             values = list("species" = "Species"))
...
formatted_last_five_length <- flextable::set_header_labels(formatted_last_five_length,
                                                      values = list("species" = "Species"))
...
formatted_last_five_age_structure <- flextable::set_header_labels(formatted_last_five_age_structure,
                                                       values = list("species" = "Species"))

#formatted_last_five_age_structure
flextable::save_as_image(formatted_last_five_age_structure, path = "formatted_last_five_years_age_structure_tally_table_2025.png")
